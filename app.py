...
<div class="main-header">
    ...
    <p>Tác giả: Lê Văn Bình - Trường PTDTBT Tiểu học Minh Tân - ĐT: 096 7494 566</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Văn Bình - Trường PTDTBT Tiểu học Minh Tân - ĐT: 096 7494 566</div>", unsafe_allow_html=True)
